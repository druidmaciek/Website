...
<div class="py-12 sm:px-12">
	...
	<div class="mt-12 grid sm:grid-cols-2 gap-10">
		...
		<div class="order-2 p-4 sm:p-8 bg-white shadow rounded">
			<form action="#" method="POST" class="mt-2 grid grid-cols-1 gap-y-6">
				<div>
				...
				<div>
					<button
						class="w-full py-2 px-4 border-2 rounded border-gray-900 font-semibold hover:bg-black hover:text-white"
						>Contact Us</button
					>
				</div>
			</form>
